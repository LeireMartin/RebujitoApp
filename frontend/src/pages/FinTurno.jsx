      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gray-800 rounded-2xl p-6 mb-6">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <p className="text-3xl font-bold text-teal-400">{state?.adivinadas ?? 0}</p>
              <p className="text-xs text-gray-400 mt-1">adivinadas</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-red-400">{state?.pasadas ?? 0}</p>
              <p className="text-xs text-gray-400 mt-1">pasadas</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-violet-400">+{state?.puntosGanados ?? 0}</p>
        ...
        {state?.siguienteEquipo && (
          <div className="bg-gray-800 rounded-2xl p-4 mb-6 text-center">
            ...
            <p className="text-xl font-bold text-violet-400">{state.siguienteEquipo}</p>
          </div>
        )}
